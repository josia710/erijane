---
name: chloeting-signup-design
description: Design system skill for chloeting-signup. Activate when building UI components, pages, or any visual elements. Provides exact color tokens, typography scale, spacing grid, component patterns, and craft rules. Read references/DESIGN.md before writing any CSS or JSX. Includes ultra-mode visual journey: read references/ANIMATIONS.md, references/LAYOUT.md, references/COMPONENTS.md, and references/INTERACTIONS.md for full motion and layout details.
---

# chloeting-signup Design System

You are building UI for **chloeting-signup**. Light-themed, cool palette, sans-serif typography (Poppins), compact density on a 4px grid, expressive motion.
...
![chloeting-signup Homepage](screenshots/homepage.png)
...
Scale: `inherit, .25rem, 1px, 2px, 3px, 4px, 6px, 7px, 8px, 9px, 10px, 12px, 14px, 16px, 18px, 20px, 22px, 24px, 26px, 28px, 32px, 35px, 40px, 97px, 100%, 100px`
Default: `16px`
...
`0, 1, 2, 3, 4, 9, 10, 15, 99, 999, 1000, 1010, 1030, 1031, 1050, 1060, 1070, 1080, 2147483645, 2147483646, 2147483647`
...
- **No arbitrary border-radius** — use the scale: .25rem, 1px, 2px, 3px, 4px, 6px, 7px, 8px, 9px, 10px
...
- **Favicon:** `/favicon.ico`
- **Site URL:** `https://chloeting.com/signup`
- **Brand color:** `#40a9ff`
...
- Creating new components, pages, or visual elements for chloeting-signup
- Writing CSS, Tailwind classes, styled-components, or inline styles
- Building page layouts, templates, or responsive designs
- Reviewing UI code for design consistency
- The user mentions "chloeting-signup" design, style, UI, or theme
...
| color-primary | `#303033` | text-primary | Headings and body text |
...
- **Border radius:** inherit, .25rem, 1px, 2px, 3px, 4px, 6px, 7px, 8px, 9px, 10px, 12px, 14px, 16px, 18px, 20px, 22px, 24px, 26px, 28px, 32px, 35px, 40px, 97px, 100%, 100px
...
- Use border-radius from the scale: inherit, .25rem, 1px, 2px, 3px
...
*Scroll position: 0px of 901px total*
...
*Scroll position: 1px of 901px total*
...
The page is **901px** tall. Each frame below shows what the user sees at that scroll depth.
...
- **50%** (`1px`) → `screens/scroll/scroll-050.png`
- **67%** (`1px`) → `screens/scroll/scroll-067.png`
- **83%** (`1px`) → `screens/scroll/scroll-083.png`
- **100%** (`1px`) → `screens/scroll/scroll-100.png`
...
| **BVMhXu** | unknown | 6× | `.bVMhXu`, `.sc-eb051afe-10` |
| **JoHhoF** | list-item | 5× | `.joHhoF`, `.sc-e0a9e758-3` |
| **Jcpoxp** | unknown | 5× | `.jcpoxp`, `.sc-e0a9e758-8` |
| **KmMsdP** | unknown | 5× | `.kmMsdP`, `.sc-ad72c0ce-0` |
| **KoIWca** | unknown | 5× | `.koIWca`, `.sc-ad72c0ce-7` |
| **Ant Input** | form-field | 5× | `.ant-input`, `.hOqArU`, `.sc-ad72c0ce-3` |
| **DZlaOr** | unknown | 4× | `.dZlaOr`, `.sc-3373780-8` |
| **GUqipM** | unknown | 4× | `.gUqipM`, `.sc-3373780-9` |
...
**CSS classes:** `.ant-input` `.hOqArU` `.sc-ad72c0ce-3`

**HTML structure:**

```html
<input placeholder="First Name" type="text" name="firstName" class="ant-input sc-ad72c0ce-3 hOqArU" value="">
```
...
**CSS classes:** `.bVMhXu` `.sc-eb051afe-10`

**HTML structure:**

```html
<div class="sc-eb051afe-10 bVMhXu"><div class="sc-ad72c0ce-0 kmMsdP"><div class="sc-ad72c0ce-7 koIWca"><input placeholder="First Name" type="text" name="firstName" class="ant-input sc-ad72c0ce-3 hOqArU" value=""></div></div></div>
```
...
**CSS classes:** `.kmMsdP` `.sc-ad72c0ce-0`

**HTML structure:**

```html
<div class="sc-ad72c0ce-0 kmMsdP"><div class="sc-ad72c0ce-7 koIWca"><input placeholder="First Name" type="text" name="firstName" class="ant-input sc-ad72c0ce-3 hOqArU" value=""></div></div>
```
...
**CSS classes:** `.koIWca` `.sc-ad72c0ce-7`

**HTML structure:**

```html
<div class="sc-ad72c0ce-7 koIWca"><input placeholder="First Name" type="text" name="firstName" class="ant-input sc-ad72c0ce-3 hOqArU" value=""></div>
```
...
**CSS classes:** `.dZlaOr` `.sc-3373780-8`

**HTML structure:**

```html
<strong class="sc-3373780-8 dZlaOr">Today’s Workout Completed!</strong>
```
...
**CSS classes:** `.gUqipM` `.sc-3373780-9`

**HTML structure:**

```html
<p class="sc-3373780-9 gUqipM">Track your daily workouts and your progress on your fitness journey</p>
```
