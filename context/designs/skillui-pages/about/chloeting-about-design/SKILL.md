---
name: chloeting-about-design
description: Design system skill for chloeting-about. Activate when building UI components, pages, or any visual elements. Provides exact color tokens, typography scale, spacing grid, component patterns, and craft rules. Read references/DESIGN.md before writing any CSS or JSX. Includes ultra-mode visual journey: read references/ANIMATIONS.md, references/LAYOUT.md, references/COMPONENTS.md, and references/INTERACTIONS.md for full motion and layout details.
---
...
![chloeting-about Homepage](screenshots/homepage.png)
...
- **Favicon:** `/favicon.ico`
- **Site URL:** `https://chloeting.com/about`
- **Brand color:** `#40a9ff`
...
- Creating new components, pages, or visual elements for chloeting-about
- Writing CSS, Tailwind classes, styled-components, or inline styles
- Building page layouts, templates, or responsive designs
- Reviewing UI code for design consistency
- The user mentions "chloeting-about" design, style, UI, or theme
...
| unknown | `#5b80d0` | unknown | Palette color |
...
The page is **3,301px** tall. Each frame below shows what the user sees at that scroll depth.
...
### 17% — Opening Section
Scroll position: 408px

![Scroll 17%](../screens/scroll/scroll-017.png)

### 33% — First Feature Section
Scroll position: 792px

![Scroll 33%](../screens/scroll/scroll-033.png)

### 50% — Mid-Page
Scroll position: 1,201px

![Scroll 50%](../screens/scroll/scroll-050.png)

### 67% — Lower Content
Scroll position: 1,609px

![Scroll 67%](../screens/scroll/scroll-067.png)

### 83% — Near Footer
Scroll position: 1,993px

![Scroll 83%](../screens/scroll/scroll-083.png)

### 100% — Bottom / Footer
Scroll position: 2,401px
...
- **17%** (`408px`) → `screens/scroll/scroll-017.png`
- **33%** (`792px`) → `screens/scroll/scroll-033.png`
- **50%** (`1201px`) → `screens/scroll/scroll-050.png`
- **67%** (`1609px`) → `screens/scroll/scroll-067.png`
- **83%** (`1993px`) → `screens/scroll/scroll-083.png`
- **100%** (`2401px`) → `screens/scroll/scroll-100.png`
...
| **DwknDW** | unknown | 6× | `.dwknDW`, `.sc-4f516a77-15` |
| **ByEuBJ** | unknown | 6× | `.byEuBJ`, `.sc-4f516a77-16` |
| **QXUSa** | list-item | 6× | `.qXUSa`, `.sc-4f516a77-20` |
| **Jcpoxp** | unknown | 5× | `.jcpoxp`, `.sc-e0a9e758-8` |
| **JoHhoF** | list-item | 4× | `.joHhoF`, `.sc-e0a9e758-3` |
| **GDliEO** | unknown | 3× | `.gDliEO`, `.sc-4f516a77-17` |
| **GDliEO** | unknown | 3× | `.gDliEO`, `.sc-4f516a77-17` |
...
**CSS classes:** `.qXUSa` `.sc-4f516a77-20`

**HTML structure:**

```html
<li class="sc-4f516a77-20 qXUSa">Master of Philosophy</li>
```
...
**CSS classes:** `.dwknDW` `.sc-4f516a77-15`

**HTML structure:**

```html
<article class="sc-4f516a77-15 dwknDW"><img src="/_next/static/media/AIAA.bfb29875.svg" width="95" alt="Female Fitness Influencer of the Year&lt;br /&gt;2021" height="66" layout="intrinsic"><p class="sc-4f516a77-16 byEuBJ">Winner</p><p class="sc-4f516a77-17 gDliEO">Female Fitness Influencer of the Year<br>2021</p></article>
```
...
**CSS classes:** `.byEuBJ` `.sc-4f516a77-16`

**HTML structure:**

```html
<p class="sc-4f516a77-16 byEuBJ">Winner</p>
```
...
**CSS classes:** `.gDliEO` `.sc-4f516a77-17`

**HTML structure:**

```html
<p class="sc-4f516a77-17 gDliEO">Female Fitness Influencer of the Year<br>2021</p>
```
...
```html
<p class="sc-4f516a77-17 gDliEO">YouTube Streamy Award for Health &amp; Wellness 2020</p>
```
