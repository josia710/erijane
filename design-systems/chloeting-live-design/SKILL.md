---
name: chloeting-live-design
description: Design system skill for chloeting-live. Activate when building UI components, pages, or any visual elements. Provides exact color tokens, typography scale, spacing grid, component patterns, and craft rules. Read references/DESIGN.md before writing any CSS or JSX.
---

# chloeting-live Design System

You are building UI for **chloeting-live**. Light-themed, cool palette, sans-serif typography (Poppins), compact density on a 4px grid, expressive motion.
...
![chloeting-live Homepage](screenshots/homepage.png)
...
- Creating new components, pages, or visual elements for chloeting-live
- Writing CSS, Tailwind classes, styled-components, or inline styles
- Building page layouts, templates, or responsive designs
- Reviewing UI code for design consistency
- The user mentions "chloeting-live" design, style, UI, or theme
...
| unknown | `#ffc53d` | unknown | Palette color |
| unknown | `#f5222d` | unknown | Palette color |
